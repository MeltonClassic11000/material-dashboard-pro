...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (let e = 0; e < w.length; e++) sidenav.classList.contains("bg-dark") && (sidenav.classList.remove("bg-dark"), sidenav.classList.add("bg-white"));
        for (x = 0; x < n.length; x++) n[x].classList.contains("light") && (n[x].classList.add("dark"), n[x].classList.remove("light"));
        for (x = 0; x < p.length; x++) p[x].classList.add("blur", "shadow-blur");
        ...
        for (x = 0; x < b.length; x++) b[x].hasAttribute("fill") && b[x].setAttribute("fill", "#252f40");
        for (x = 0; x < h.length; x++) h[x].closest(".card.bg-gradient-dark") || (h[x].classList.remove("text-white"), h[x].classList.add("text-dark"));
        ...
        for (let t = 0; t < w.length; t++) {
            let e = w[t];
            console.log(e), e.classList.contains("bg-white") && (e.classList.remove("bg-white"), e.classList.add("bg-dark"))
        }
        for (var x = 0; x < p.length; x++) p[x].classList.contains("blur") && p[x].classList.remove("blur", "shadow-blur");
        ...
        for (var x = 0; x < b.length; x++) b[x].hasAttribute("fill") && b[x].setAttribute("fill", "#fff");
        for (var x = 0; x < v.length; x++) v[x].classList.add("border-dark");
