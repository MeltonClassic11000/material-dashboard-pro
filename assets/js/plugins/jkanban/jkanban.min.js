            ...
            this.jKanban = function() {
                ...
                arguments[0] && "object" == typeof arguments[0] && (this.options = function(e, t) {
                    ...
                    for (var f in t) {
                        ...
                        m.dataset.id = p.id, m.dataset.order = e.container.childNodes.length + 1, m.classList.add("kanban-board"), e.options.responsivePercentage ? m.style.width = o + "%" : m.style.width = o, m.style.marginLeft = e.options.gutter, m.style.marginRight = e.options.gutter;
                        var v = document.createElement("header");
                        if ("" !== p.class && void 0 !== p.class) var h = p.class.split(",");
                        else h = [];
                        v.classList.add("kanban-board-header"), h.map(function(e) {
                            e = e.replace(/^[ ]+/g, ""), v.classList.add(e)
                        }), v.innerHTML = '<div class="kanban-title-board">' + p.title + "</div>";
                        var g = document.createElement("main");
                        if (g.classList.add("kanban-drag"), "" !== p.bodyClass && void 0 !== p.bodyClass) var b = p.bodyClass.split(",");
                        else b = [];
                        for (var y in b.map(function(e) {
                            ...
                            E.classList.add("kanban-item"), w.id && (E.dataset.eid = w.id), w.class && Array.isArray(w.class) && w.class.forEach(function(e) {
                                E.classList.add(e)
                            }), E.innerHTML = s(w.title), E.clickfn = w.click, E.dragfn = w.drag, E.dragendfn = w.dragend, E.dropfn = w.drop, d(E, w), r(E), e.options.itemHandleOptions.enabled && (E.style.cursor = "default"), g.appendChild(E)
                        }
                        var T = document.createElement("footer");
                        if (i) {
                            var C = document.createElement("BUTTON"),
                                O = document.createTextNode(c || "+");
                            C.setAttribute("class", l || "kanban-title-button btn btn-default btn-xs"), C.appendChild(O), u ? T.appendChild(C) : v.appendChild(C), a(C, p.id)
                        }
                        m.appendChild(v), m.appendChild(g), m.appendChild(T), e.container.appendChild(m)
                    }
                    return e
        ...
        (function(n) {
            (function() {
                ...
                t.exports = function(e, t) {
                    ...
                    function X(e) {
                        if (O = e.clientX, k = e.clientY, 1 === s(e) && !e.metaKey && !e.ctrlKey) {
                            var t = e.target,
                                n = j(t);
                    ...
                    function Y(e) {
                        if (N)
                            if (0 !== s(e)) {
                                if (!(void 0 !== e.clientX && Math.abs(e.clientX - O) <= (A.slideFactorX || 0) && void 0 !== e.clientY && Math.abs(e.clientY - k) <= (A.slideFactorY || 0))) {
                                    ...
                                    T = y("pageX", e) - f.left, C = y("pageY", e) - f.top, r.add(L || E, "gu-transit"),
                                        function() {
                                            if (!n) {
                                                var e = E.getBoundingClientRect();
                                                (n = E.cloneNode(!0)).style.width = m(e) + "px", n.style.height = v(e) + "px", r.rm(n, "gu-transit"), r.add(n, "gu-mirror"), A.mirrorContainer.appendChild(n), d(c, "add", "mousemove", Q), r.add(A.mirrorContainer, "gu-unselectable"), _.emit("cloned", n, E, "mirror")
                                            }
                                        }(), Q(e)
                                }
                            } else K({})
                    ...
                    function j(e) {
                        if (!(_.dragging && n || H(e))) {
                            ...
                            var o = h(e);
                            if (o && !A.invalid(e, t) && A.moves(e, o, t, b(e))) return {
                                item: e,
                                source: o
                            }
                        }
                    ...
                    function F(e) {
                        var t, n;
                        t = e.item, n = e.source, ("boolean" == typeof A.copy ? A.copy : A.copy(t, n)) && (L = e.item.cloneNode(!0), _.emit("cloned", L, e.item, "copy")), w = e.source, E = e.item, S = x = b(e.item), _.dragging = !0, _.emit("drag", E, w)
                    }
                    ...
                    function K(e) {
                        if (U(), _.dragging) {
                            var t = L || E,
                                ...
                                i = y("clientY", e) || 0,
                                r = J(u(n, o, i), o, i);
                            r && (L && A.copySortSource || !L || r !== w) ? z(t, r) : A.removeOnSpill ? W() : G()
                        }
                    }

                    function z(e, t) {
                        var n = h(e);
                        L && A.copySortSource && t === w && n.removeChild(E), $(t) ? _.emit("cancel", e, w, w) : _.emit("drop", e, t, w, x), V()
                    }
                    ...
                    function G(e) {
                        if (_.dragging) {
                            var t = arguments.length > 0 ? e : A.revertOnSpill,
                                ...
                                o = h(n),
                                i = $(o);
                            !1 === i && t && (L ? o && o.removeChild(L) : w.insertBefore(n, S)), i || t ? _.emit("cancel", n, w, w) : _.emit("drop", n, o, w, x), V()
                        }
                    }

                    function V() {
                        var e = L || E;
                        U(), n && (r.rm(A.mirrorContainer, "gu-unselectable"), d(c, "remove", "mousemove", Q), h(n).removeChild(n), n = null), e && r.rm(e, "gu-transit"), B && clearTimeout(B), _.dragging = !1, I && _.emit("out", e, I, w), _.emit("dragend", e), w = E = L = S = x = B = I = null
                    }
                        ...
                        if (n) {
                            ...
                            if (d !== w || !L || A.copySortSource) {
                                ...
                                if (null !== p) f = ee(d, p, t, o);
                                    ...
                                    f = S, d = w
                                }(null === f && s || f !== a && f !== b(a)) && (x = f, d.insertBefore(a, f), _.emit("shadow", a, d, w))
                    ...
                    function ee(e, t, n, o) {
                        ...
                        return t !== e ? (i = t.getBoundingClientRect(), a(r ? n > i.left + m(i) / 2 : o > i.top + v(i) / 2)) : function() {
